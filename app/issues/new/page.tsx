...
export default function NewIssue() {
   ...
   const create = async (data:IssueForm)=>{
    ...
    return (
   <Form {...form}>
   <form onSubmit={form.handleSubmit(create)} className="space-y-6 w-[90vw] sm:w-[450px] mx-auto mt-10 sm:m-10">
     <FormField
     ...
     />
     <Button type="submit" disabled={form.formState.isSubmitting} className="w-40">{ form.formState.isSubmitting?<Spinner size={15} color='white'/>: "Create issue"}</Button>
   </form>
 </Form>
    )
  }
